...
user_permission_table = Table(
    ...
    Column(
        "permission_name",
        String,
        ForeignKey("global_permission.name"),
        primary_key=True,
    ),
)
...
mapper_registry.map_imperatively(
    Permission, permission_table, properties={"permission": permission_table.c.name}
)
...
mapper_registry.map_imperatively(
    ...
    properties={
        ...
        "permissions": relationship(
            Permission, secondary="auth_user_permission", backref="global_permission"
        ),
    },
)
